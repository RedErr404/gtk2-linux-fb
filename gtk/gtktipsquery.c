...
gtk_tips_query_class_init (GtkTipsQueryClass *class)
{
  ...
  tips_query_signals[SIGNAL_START_QUERY] =
    gtk_signal_new (g_intern_static_string("start_query"),
		    GTK_RUN_FIRST,
  ...
  tips_query_signals[SIGNAL_STOP_QUERY] =
    gtk_signal_new (g_intern_static_string("stop_query"),
		    GTK_RUN_FIRST,
		    GTK_CLASS_TYPE (object_class),
  ...
  tips_query_signals[SIGNAL_WIDGET_ENTERED] =
    gtk_signal_new (g_intern_static_string("widget_entered"),
		    GTK_RUN_LAST,
		    GTK_CLASS_TYPE (object_class),
  ...
  tips_query_signals[SIGNAL_WIDGET_SELECTED] =
    g_signal_new (g_intern_static_string("widget_selected"),
